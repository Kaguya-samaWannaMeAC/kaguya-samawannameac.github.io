...
$$
\begin{aligned}
& [x^{2k}](k-1)!\prod_{i=1}^{k+1}f_{a_i}(x) \newline
=& [x^{2k}](k-1)!\prod_{i=1}^{k+1}a_ixe^{a_ix} \newline
=& [x^{2k}](k-1)!\left(\prod_{i=1}^{k+1}a_i\right)x^{k+1}\left(\prod_{i=1}^{k+1}e^{a_ix}\right) \newline
=& [x^{2k}](k-1)!\left(\prod_{i=1}^{k+1}a_i\right)x^{k+1}e^{\left(\sum \limits _{i=1}^{k+1}a_ix\right)} \newline
=& [x^{k-1}](k-1)!\left(\prod_{i=1}^{k+1}a_i\right)e^{nx} \newline
