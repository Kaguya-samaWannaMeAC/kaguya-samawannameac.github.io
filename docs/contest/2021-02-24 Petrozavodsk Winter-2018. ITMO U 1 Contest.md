...
\frac{1}{(r - l)^n}\int_{l}^{r}\frac{1}{t_1}\cdot \frac{1}{n}\cdot \frac{1}{\operatorname{ln}\frac{t_1}{r}}{(r - t_1 + p_1 \operatorname{ln}{\frac{t_1}{r}})^n}\operatorname{|}_{0}^{t_1}dt_1\newline =&
